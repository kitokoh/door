            ...
            <ul class="title-bar" data-responsive-toggle="responsive-menu">
              <li class="name">
                <?php if (doors_get_option('doors_show_logo') == '1') { ?>
                  ...
                  if (!empty($image)) { ?>
                    <h1><a href="<?php echo esc_url(home_url('/')); ?>" rel="home" title="<?php echo bloginfo('name') ?>" class="active">
                        <img src="<?php echo esc_url($image) ?>" alt="<?php echo bloginfo('name') ?>" /></a>
                    </h1>
                  <?php }
                } 
                if (doors_get_option('doors_show_title', '1') == '1') : ?>
                  <a href="<?php echo esc_url(home_url('/')); ?>">
                    <h2 class="p-t-20"><?php echo bloginfo('name') ?></h2>
                  </a>
                <?php endif ?>
              </li>
            </ul>
            ...
            <?php if (doors_get_option('adress') != "") { ?>
              <div class="address_bar">
                ...
                <ul class="bar">
                  ...
                  <li class="text_add"><?php echo esc_html(doors_get_option('adress', '547, San Diego')); ?></li>
                </ul>
              </div>
            <?php } ?>
        ...
        <div class="row">
          <?php
            ...
            <div class="icon-header">
              ...
              <?php $text_button_header = doors_get_option('button'); ?>
              <div class="request-quote" <?php if (empty($text_button_header)) { echo ' style = "display: none" '; } ?>>
                <a href="<?php echo esc_url(doors_get_option('doors_button_link')); ?>" class="has-icon"><?php echo esc_html($text_button_header); ?></a>
              </div>
            </div>
        </div>
      </section>
