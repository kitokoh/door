jQuery(document).ready(function ($) {
    "use strict";
    var $thumbs_wrap, $input_gallery_items;
        ...
        wp.media.customlibEditGallery = {
            ...
            frame: function () {
                ...
                this._frame = wp.media({
                    id: 'doors_portfolio-image-gallery',
                    frame: 'post',
                    state: 'gallery-edit',
                ...
                this._frame.on('update', function () {
                    ...
                    jQuery.ajax({
                        type: "post",
                        url: ajaxurl,
                        data: "action=doors_gallery_upload_get_images&ids=" + ids,
            ...
            select: function () {
                ...
                var shortcode = wp.shortcode.next('gallery', '[gallery ids="' + $input_gallery_items.val() + '"]'),
                    defaultPostId = wp.media.gallery.defaults.id, attachments, selection;
