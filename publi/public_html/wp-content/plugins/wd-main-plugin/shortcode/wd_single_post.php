  	...
  	<div class="one_post_box large-12">
		  	...
		  	if( is_object( $the_post ) ):?>
			    <div class="box_image large-9 columns">					
					<?php echo get_the_post_thumbnail( $the_post->ID, 'doors_1900x620'); ?>					      
...
add_shortcode( 'doors_one_post', 'doors_one_post' ); ?>