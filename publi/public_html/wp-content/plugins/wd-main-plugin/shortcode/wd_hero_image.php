<?php
if(!function_exists('doors_hero_image')){
	function doors_hero_image($atts) {
		...
		ob_start(); ?>
		<div class="wd-hero-image <?php echo $classes; ?>">
			<div class="wd-overlay"></div>
			<div class="wd-image" style="background-image: url(<?php echo $img_path; ?>);"></div>
	...
	add_shortcode( 'doors_hero_image', 'doors_hero_image' );
}
?>