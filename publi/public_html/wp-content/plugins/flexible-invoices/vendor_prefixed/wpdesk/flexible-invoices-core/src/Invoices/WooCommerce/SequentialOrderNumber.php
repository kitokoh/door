...
class SequentialOrderNumber implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        if (\class_exists('WPDeskFIVendor\\Automattic\\WooCommerce\\Utilities\\OrderUtil')) {
            return \WPDeskFIVendor\Automattic\WooCommerce\Utilities\OrderUtil::custom_orders_table_usage_is_enabled();
        }
        return \false;
    }
    /**
