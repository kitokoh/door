...
<div class="notice notice-large is-dismissible notice-info gswpts-review-notice">
	<p><?php esc_html_e( 'Hi there, it seems like', 'sheetstowptable' ); ?>
		...
		</a> <?php esc_html_e( 'is bringing you some value, and that is pretty awesome! Can you please show us some love and rate', 'sheetstowptable' ); ?> 
		<a href="https://wordpress.org/plugins/sheets-to-wp-table-live-sync/" target="_blank">
			<?php echo esc_html( SWPTLS_PLUGIN_NAME ); ?>
		</a> <?php esc_html_e( 'on WordPress? It will take two minutes of your time, and will really help us spread the world.', 'sheetstowptable' ); ?>
	</p>
	...
	<div class="notice-actions">
		...
		<a href="#" class="hide_notice" data-value="hide_notice"><?php esc_html_e( 'I\'ve already rated you', 'sheetstowptable' ); ?></a>
	</div>
	...
	<div class="notice-overlay-wrap">
		<div class="notice-overlay">
			...
			<div class="notice-overlay-actions">
				...
				<a href="#" data-value="hide_notice"><?php esc_html_e( 'Don\'t remind me about this', 'sheetstowptable' ); ?></a>
			</div>
