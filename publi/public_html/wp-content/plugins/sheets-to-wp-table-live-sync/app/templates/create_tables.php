			...
			<div class="col-12 p-0 d-flex align-items-center">
				...
				<div class="col p-0 d-flex align-items-center justify-content-end">
					<button id="create_button"
						...
						style="padding-left: 30px;" data-nonce="<?php echo esc_attr( wp_create_nonce( 'swptls_sheet_creation_nonce' ) ); ?>">
					...
					<button class="ui violet button m-0 transition hidden fetch_save_btn" type="button"
						req-type="<?php echo ! empty( $table_id ) ? 'save' : 'fetch' ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'swptls_sheet_creation_nonce' ) ); ?>">
						<span class="btn_text">
						...
						<section>
							<div class="col-12 p-0">
								<form id="gswpts_create_table" class="ui form">
									<input type="hidden" id="gswpts_sheet_nonce" name="gswpts_sheet_nonce" value="<?php echo esc_attr( wp_create_nonce( 'gswpts_sheet_nonce_action' ) ); ?>">
									<?php swptls()->helpers->nonceField( 'gswpts_sheet_nonce_action', 'gswpts_sheet_nonce' ); ?>
										...
										<div class="col-12 col-md-3">
											<div class="ui fluid search selection dropdown" id="table_type">
												...
												<div class="default text">
													<?php esc_html_e( 'Choose Source Type', 'sheetstowptable' ); ?></div>
												<div class="menu">
