...
class ManageNotices {
	...
	public function __construct() {
		add_action( 'wp_ajax_gswpts_notice_action', [ $this, 'manageNotices' ] );
		add_action( 'wp_ajax_nopriv_gswpts_notice_action', [ $this, 'manageNotices' ] );
	}
	...
	public function manageNotices() {
		if ( ! wp_verify_nonce( $_POST['nonce'], 'swptls_notices_nonce' ) ) {
			wp_send_json_error([
