...
if ( ! class_exists( 'WPPOOL_Plugin' ) ) {
	...
	final class WPPOOL_Plugin {
		...
		public $plugins = [
			...
			'wp_dark_mode'                                 => [
				'list_id'     => 20,
				'button_link' => 'https://go.wppool.dev/winy',
				'button_text' => 'Get Premium',
				'color'       => '#FF631A',
			],
		...
		public function get_default_background_image_url() {
			$image_url = file_exists( __DIR__ . '/background-image-not-cached.png' )
				? plugin_dir_url( __FILE__ ) . '/background-image-not-cached.png'
				: 'https://raw.githubusercontent.com/imjafran/sample-images/master/stock-sync-with-google-sheet-for-woocommerce.png';
											...
											<div class="_wppool-popup-modal-footer">
												...
												<div class="_wppool-popup-countdown" style="display: none">
													...
													<div class="_wppool-popup-countdown-time">
														<div>
															<span data-counter="days"><?php echo esc_html__( '00', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
															<span><?php echo esc_html__( 'Days', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
														</div>
														<span>:</span>
														<div>
															<span data-counter="hours"><?php echo esc_html__( '00', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
															<span><?php echo esc_html__( 'Hours', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
														</div>
														<span>:</span>
														<div>
															<span data-counter="minutes"><?php echo esc_html__( '00', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
															<span><?php echo esc_html__( 'Minutes', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
														</div>
														<span>:</span>
														<div>
															<span data-counter="seconds"><?php echo esc_html__( '00', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
															<span><?php echo esc_html__( 'Seconds', 'stock-sync-with-google-sheet-for-woocommerce' ); ?></span>
														</div>
													</div>
												</div>
		...
		public function get_plugin_image() {
			return plugin_dir_url( __FILE__ ) . 'background-image-not-cached.png';
		}
		 ...
		 * @return self
		 */
		public static function init( $plugin_id = 'wp_dark_mode' ) {
			$instance = new self( $plugin_id );

			// Add plugin image.
			add_filter('wppool_plugins', [ $instance, 'add_plugin_image' ] );
		 ...
		 * @return array
		 */
		public function add_plugin_image( $plugins ) {
			$plugins[ $this->plugin_id ]['background_image'] = $this->get_plugin_image();
	 ...
	 * @return void
	 */
	function wppool_plugin_init( $plugin_id = 'wp_dark_mode' ) {
		\WPPOOL_Plugin::init( $plugin_id );
	}
}