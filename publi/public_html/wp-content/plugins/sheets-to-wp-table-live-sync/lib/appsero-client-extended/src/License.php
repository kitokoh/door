			...
			<div class="wrap appsero-license-settings-wrapper">
				...
				<div class="appsero-license-settings appsero-license-section">
					...
					<div class="appsero-license-details">
						...
						<?php else: ?>
						<p>
							<?php echo wp_kses_post( wp_sprintf( $this->client->__trans( 'Activate <strong>%s</strong> by your license key to get professional support and automatic update from your WordPress dashboard.' ), esc_html( $this->client->name ) ) ); ?>
						</p>
						<?php endif; ?>
